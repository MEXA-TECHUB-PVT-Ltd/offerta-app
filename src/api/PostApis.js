...
export const post_Comments_Listings = async (listing_id,description) => {
    var user_id=await AsyncStorage.getItem("Userid")
    console.log("here we go fo in functionr",listing_id,description)
...
export const post_Listings_Exchange_Offer = async (props) => {
    console.log("here data of exchange:",props)
...
/////////////////////Price Offer////////////
export const post_Listings_Price_Offer = async (other_user,other_listings,offer_price) => {
    var user_id=await AsyncStorage.getItem("Userid")
    console.log("here props:",user_id,other_user,other_listings,offer_price)
...
export const post_Follow_Users = async (props) => {
    var user_id=await AsyncStorage.getItem("Userid")
    console.log("here props in follow function:",user_id,props)
