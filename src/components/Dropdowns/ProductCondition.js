...
const [rangedata] = useState([
  {id:'1',condition:'One Day'},
  {id:'2',condition:'One Week'},
  {id:'3',condition:'One Month'},
  ...
  return (
    ...
    >
      ...
      >
        <Text style={styles.bottomsheettext}>{props.type === "PostedRange"?"Select Posted Range":"Select Product Condition"}</Text>
      </View>
      <FlatList
        data={props.type === "PostedRange"?rangedata:dddata}
