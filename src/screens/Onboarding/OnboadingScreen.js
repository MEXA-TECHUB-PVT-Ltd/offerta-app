...
const OnboardingScreen = ({ navigation }) => {
    ...
    return (
        ...
        <View style={Onboardingstyles.textview}>
          <Text style={Onboardingstyles.text}>Discover Your Next
Style</Text>
          <Text style={Onboardingstyles.subtext}>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod
          </Text>
        </View>

<TouchableOpacity style={Onboardingstyles.btnview}
...
>
    ...
    <Text style={Onboardingstyles.btntext}>Get Started
          </Text>
</TouchableOpacity>
